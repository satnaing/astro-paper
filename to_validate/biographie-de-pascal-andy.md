...
author: "Pascal Andy"
description: "J'ai toujours été un patenteux, quelqu’un qui entreprend des projets. Pour moi, c'est une façon de vivre. J'aime questionner et résoudre ce qui est complexe. "
ogImage: "/og-legacy/2017/06/my_story-1462985245244.jpg"
---
## Version courte
...
Durant mes études en 2011, je lance [repost] qui permet à mes clients de réafficher sur Kijiji leurs annonces automatiquement, une ou deux fois par jours. On peut [voir les archives](/repost-ma-premiere-startup/) des deux sites web. Fait entièrement sur iWeb qui était fourni avec le Mac. Fallait le faire!

En **2012** , je lance [FollowFi](/followfi-permet-aux-patients-dattendre-a-distance-avec-leur-telephone-intelligent/) qui est une application web qui permet aux patients de gérer leur temps comme ils le souhaitent à l'extérieur des salles d'attente.
...
En mai **2017** , je prends un poste d'analyste d'affaires à la Banque Nationnale comme Analyste d’Affaires Sénior Infrastructures dans le Centre Transformation Office (CTO). Détails sur [Linkedin](https://www.linkedin.com/in/pascalnguyendeschenes/).

Dans la même période, je démarre [FirePress](https://firepress.org/). Chez **FirePress** , ont se donne à 100% afin de permettre aux entrepreneurs et aux petites organisations de créer leurs sites web. Nous faisons l'hébergement de sites web sur Ghost en plus d'aider leurs clients à se familiariser avec la plate-forme.

En mars **2018** , je prends un poste chez Desjardins comme d'analyste d'affaires sénior dans l'équipe Conception solution prêt entreprise.
...
À la même époque, je commence à jouer avec la guitare de ma mère qui traîne dans le garde-robe de sa chambre. Après avoir fait le tour de jouer à une corde, je commence à suivre des cours une fois par semaine durant une année. Je passe le clair de mon temps à _jouer de la guitârr_ comme disait Jean Leloup.

**À 16 ans** \- Je perds la finale de ping-pong en 4e secondaire. Je prends ma retraite le lendemain et décide de focuser sur le billard. À 17 ans, à force de jouer au billard tous les midis, je réussis à « vider une table ». Je prends ma retraite des _pools_ pour me concentrer sur les technos.

**À 18 ans** \- Je décide de suivre une **technique en génie électrique** au Collège de Limoilou. J'y perds vite intérêt et décide de quitter le programme durant ma troisième session pour devenir programmeur-analyste au Collège CDI à Québec. Le film _la Matrix_ a particulièrement contribué à ma décision à cette époque.
...
**Septembre 2013** \- Je présente officiellement ma deuxième startup [FollowFi](/followfi-permet-aux-patients-dattendre-a-distance-avec-leur-telephone-intelligent/) lors de l'**émission Le Banquier**.
...
«L’argent rentre s’a page #1» est une plateforme logicielle avec laquelle PND Design réaffiche automatiquement les annonces de ses clients. L’intérêt de ceux-ci? Être vus et trouvés sur la première page et ce, tous les jours.

7. L’étroite relation qui s’est installée entre nous et notre environnement technologique est une relation qui bouscule ou même dépasse une majorité d’entre nous. Je possède une vision d’ensemble et une expérience concrète de ce qu’est la gestion d’une entreprise web ainsi que celle d’une entreprise de service. » [...]

* * *

__[source](http://theransomchurch.org/phill/whats-your-story-2/)