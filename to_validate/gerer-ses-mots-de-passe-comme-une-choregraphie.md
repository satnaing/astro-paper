...
author: "Pascal Andy"
description: "Personne n’aime gérer ou bien se souvenir de ses mots de passe. Pour plusieurs d’entre nous, la partie de notre cerveau qui devait gérer ceux-ci est partie jouer à la cachette"
ogImage: "/og-legacy/2017/04/gerer_ses_mots_de_passe_comme_une_choregraphie_en_deux_actes-1462900077996.jpg"
---
...
Notre réaction naturelle pour résoudre ce problème a été de se choisir un seul et même mot de passe. Un mot qui représente quelque chose de tangible dans notre quotidien. Exemple : ma voiture est une Civic rouge, alors ça sera “civicrouge” (ou pire encore “civic”). On se tape dans les mains en se disant : « Quin! sti, une bonne affaire de faite mon [Lekt](/lekt-le-lecteur/) ! »
...
Pour en remettre une couche, des entreprises comme [Home Depot](http://www.homedepot.ca/l-entreprise/relations-avec-les-medias/message), [Target USA et Canada](http://affaires.lapresse.ca/economie/commerce-de-detail/201401/20/01-4730627-failles-de-securite-chez-target-possibles-vols-de-renseignements-personnels.php), [Evernote](https://nakedsecurity.sophos.com/2013/03/02/evernote-hacked-almost-50-million-passwords-reset-after-security-breach/), [iCloud](http://www.buzzfeed.com/rachelzarrell/jennifer-lawrence-ariana-grande-picture-leak), [Zendesk](http://www.infoworld.com/article/2613370/intrusion-detection/zendesk-says-security-breach-compromised-email-addresses.html), doivent avouer publiquement les failles de sécurité de leurs systèmes. Je ne parle même pas du fait que la NSA [espionne le monde entier](http://www.washingtonpost.com/wp-srv/special/politics/prism-collection-documents/) à travers leur programme Prism. Nous pouvons tous remercier les sacrifices que fait actuellement [Edward Snowdon](http://www.theguardian.com/world/2013/jun/09/edward-snowden-nsa-whistleblower-surveillance) dans le but que les gens du monde entier soient conscients de l'ampleur de la surveillante de masse sous laquelle nous somme présentement. Des scénarios bien réels qui ressemblent trop à « La Matrice ».

La faille de sécurité [heartbleed](http://www.forbes.com/sites/josephsteinberg/2014/04/10/massive-internet-security-vulnerability-you-are-at-risk-what-you-need-to-do/) à fait en sorte que plus de 500 000 de sites web sécurisés par le protocole SSL https:// ont été durant des mois, exposés à être non sécure par des pirates au fait de cette faille.

Matt Honan du réputé Wired Magazine s'est fait [défoncer son identité digitale](http://www.wired.com/2012/08/apple-amazon-mat-honan-hacking/all/). Ça frappe solide quand ta vie digitale disparaît.
...
Te souviens-tu du [vidéo clip épique](http://youtu.be/h_D3VFfhvs4?t=1m43s) « Smooth Criminal » de Michael Jackson ? Nous allons reproduire ça sur notre clavier.
...
Plaçons maintenant les deux lettres “**g** ” et “**b** ” à la fin de la chorégraphie. Le résultat final donnera : (IJhu8&YGft6**gb**. À moins que tu t'appelles [Rain Man](https://www.youtube.com/watch?v=KKC3W0awjm0), le mot de passe (IJhu8&YGft6gb semble ne faire référence à rien du tout.
...
- Pour **Gmail** le mot de passe donnera : (IJhu8&YGft6**hn**
- Pour Amazon le mot de passe donnera : (IJhu8&YGft6**bn**
- etc. …

Avec les méthodes utilisées par les pirates qui consistent à trouver un mot de passe par essai et erreur (_bruteforce_), un mot de passe comme “civicrouge” peut se trouver en seulement **9 heures**. Le mot de passe “(IJhu8&YGft6gb” peut se déchiffrer en **26 millions d’années**. Cette estimation descend toutes les semaines/mois grâce à la [loi de Moore](http://fr.wikipedia.org/wiki/Loi_de_Moore). Pour avoir une idée de la complexité de tes mots passe, je te conseil d'essayer [cet outil](http://howsecureismypassword.net/).
...
- Prendre la lettre avant (_et non après_) des deux premières lettres du site visité. (“**ez** ” dans l’exemple de Facebook)
...
__[#1](https://500px.com/photo/67918585/tango-in-the-night-by-photocafe-) / [#2](https://secure.flickr.com/photos/tchao/1612966152)