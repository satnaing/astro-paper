    ...
    showEditPost && (
      <>
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="scale-90 inline-block h-6 w-6 min-w-[1.375rem] fill-skin-base icon icon-tabler icons-tabler-outline icon-tabler-edit"
            aria-hidden="true"
          >
          ...
          <span class="ml-2 italic text-base">{editPostText}</span>
        </a>
      </>
    )
  );
